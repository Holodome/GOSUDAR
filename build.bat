...
@REM set "build_options=-nologo -DEBUG -fp:fast -Od -Oi -Zi -FC -MTd -W4 -wd4201 -WX -I"..\src" -std:c++17 -D_CRT_SECURE_NO_WARNINGS"
set "build_options=-nologo -DEBUG -fp:fast -Od -Oi -Zi -FC -MTd -wd4201 -WX -I"..\src" -std:c++17 -D_CRT_SECURE_NO_WARNINGS"
