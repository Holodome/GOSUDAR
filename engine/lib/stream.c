...
void init_out_streamf(OutStream *stream, OS_File_Handle *file,  void *bf, uptr bf_sz, uptr threshold) {
...
void init_in_streamf(InStream *stream, OS_File_Handle *file, void *bf, uptr bf_sz, uptr threshold) {
