...
pack_rgba_4x8_linear1(f32 r, f32 b, f32 g, f32 a) {
    u32 ru = roundf(Math::clamp(r, 0, 1 - FLT_EPSILON) * 255);
    u32 gu = roundf(Math::clamp(g, 0, 1 - FLT_EPSILON) * 255);
    u32 bu = roundf(Math::clamp(b, 0, 1 - FLT_EPSILON) * 255);
    u32 au = roundf(Math::clamp(a, 0, 1 - FLT_EPSILON) * 255);
